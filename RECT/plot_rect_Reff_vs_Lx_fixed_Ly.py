...
xlabel="$L_x$"; ylabel="$R_{\mathrm{eff}}$"
...
import re
print('here')
path = 'Reff_vs_Lx_fixed_Ly*_rect.dat'
List=[]
...
for Ly in List:
     ...
     dir='.' 
     #dir='../DATAFILES'
     datafile = '{}/Reff_vs_Lx_fixed_Ly{}_rect.dat'.format(dir,Ly)
...
ax.legend(loc='upper left', prop=dict(size=30))
...
# Annotation 
xannote=150; yannote=35 # absolute coordinates
...
# SAVE AND SHOW PLOT
# -----------------------------------
fname='Reff_vs_Lx_fixed_Ly_rect'
