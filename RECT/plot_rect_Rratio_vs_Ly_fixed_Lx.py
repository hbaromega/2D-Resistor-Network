...
xlabel="$L_y$"; ylabel="$R_{\mathrm{eff}}$ $L_y$/$(R L_x)$"
...
import re
print('here')
path = 'Rratio_vs_Ly_fixed_Lx*_rect.dat'
List=[]
...
for Lx in List:
     ...
     dir='.' 
     #dir='../DATAFILES'
     datafile = '{}/Rratio_vs_Ly_fixed_Lx{}_rect.dat'.format(dir,Lx)
...
ax.legend(loc='upper right', prop=dict(size=30))
...
# Annotation 
xannote=150; yannote=1 # absolute coordinates
#bbox_props = dict(boxstyle="rarrow,pad=0.3", fc="cyan", ec="b", lw=2)
bbox_props = dict(boxstyle="round", fc="silver", ec="0.5", alpha=0.9)
ax.text(xannote, yannote, "Rectangular", ha="center", va="center", size=40, bbox=bbox_props)
...
# SAVE AND SHOW PLOT
# -----------------------------------
fname='Rratio_vs_Ly_fixed_Lx_rect'
#plt.tight_layout()
