...
def main():
  ...
  for Ly in L_list:
    ...
    f0=open('Reff_vs_Lx_fixed_Ly{}_rect.dat'.format(Ly), 'w')
    f1=open('Rratio_vs_Lx_fixed_Ly{}_rect.dat'.format(Ly), 'w')
    print('f0=',f0)
  ...
  import plot_rect_Reff_vs_Lx_fixed_Ly 
  import plot_rect_Rratio_vs_Lx_fixed_Ly 
