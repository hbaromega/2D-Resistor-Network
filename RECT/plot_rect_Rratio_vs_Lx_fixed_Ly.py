...
import re
print('here')
path = 'Rratio_vs_Lx_fixed_Ly*_rect.dat'
List=[]
...
for Ly in List:
     ...
     dir='.' 
     #dir='../DATAFILES'
     datafile = '{}/Rratio_vs_Lx_fixed_Ly{}_rect.dat'.format(dir,Ly)
...
# Annotation 
xannote=150; yannote=1.0 # absolute coordinates
...
# SAVE AND SHOW PLOT
# -----------------------------------
fname='Rratio_vs_Lx_fixed_Ly_rect'
