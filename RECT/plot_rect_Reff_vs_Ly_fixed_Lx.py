...
xlabel="$1/L_y$"; ylabel="$R_{\mathrm{eff}}$"
...
path = 'Reff_vs_Ly_fixed_Lx*_rect.dat'
List=[]
...
for Lx in List:
     ...
     dir='.' 
     #dir='../DATAFILES'
     datafile = '{}/Reff_vs_Ly_fixed_Lx{}_rect.dat'.format(dir,Lx)
...
# Annotation 
xannote=0.4; yannote=180 # absolute coordinates
...
# SAVE AND SHOW PLOT
# -----------------------------------
fname='Reff_vs_Ly_fixed_Lx_rect'
