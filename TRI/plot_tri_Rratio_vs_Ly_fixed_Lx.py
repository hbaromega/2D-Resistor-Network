...
import re
print('here')
path = 'Rratio_vs_Ly_fixed_Lx*_tri.dat'
List=[]
...
for Lx in List:
     ...
     dir='.' 
     #dir='../DATAFILES'
     datafile = '{}/Rratio_vs_Ly_fixed_Lx{}_tri.dat'.format(dir,Lx)
...
# Annotation 
xannote=50; yannote=1.6 # absolute coordinates
#bbox_props = dict(boxstyle="rarrow,pad=0.3", fc="cyan", ec="b", lw=2)
bbox_props = dict(boxstyle="round", fc="silver", ec="0.5", alpha=0.9)
ax.text(xannote, yannote, "Triangular", ha="center", va="center", size=40, bbox=bbox_props)
...
# SAVE AND SHOW PLOT
# -----------------------------------
fname='Rratio_vs_Ly_fixed_Lx_tri'
