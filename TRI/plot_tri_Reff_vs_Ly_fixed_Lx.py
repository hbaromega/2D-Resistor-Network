...
path = 'Reff_vs_Ly_fixed_Lx*_tri.dat'
List=[]
...
for Lx in List:
     ...
     dir='.' 
     #dir='../DATAFILES'
     datafile = '{}/Reff_vs_Ly_fixed_Lx{}_tri.dat'.format(dir,Lx)
...
# Annotation 
xannote=0.4; yannote=150 # absolute coordinates
