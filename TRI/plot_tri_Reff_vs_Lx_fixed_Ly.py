...
import re
print('here')
path = 'Reff_vs_Lx_fixed_Ly*_tri.dat'
List=[]
...
for Ly in List:
     ...
     dir='.' 
     #dir='../DATAFILES'
     datafile = '{}/Reff_vs_Lx_fixed_Ly{}_tri.dat'.format(dir,Ly)
...
# Annotation 
xannote=150; yannote=25 # absolute coordinates
