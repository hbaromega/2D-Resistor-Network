...
import re
print('here')
path = 'Rratio_vs_Lx_fixed_Ly*_tri.dat'
List=[]
...
for Ly in List:
     ...
     dir='.' 
     #dir='../DATAFILES'
     datafile = '{}/Rratio_vs_Lx_fixed_Ly{}_tri.dat'.format(dir,Ly)
...
ax.legend(loc='lower right', prop=dict(size=30))
...
# Annotation 
xannote=150; yannote=1.5 # absolute coordinates
...
# SAVE AND SHOW PLOT
# -----------------------------------
fname='Rratio_vs_Lx_fixed_Ly_tri'
