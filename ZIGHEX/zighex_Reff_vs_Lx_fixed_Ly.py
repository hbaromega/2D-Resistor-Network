...
def main():
  ...
  for Ly in L_list:
    ...
    f0=open('Reff_vs_Lx_fixed_Ly{}_zighex.dat'.format(Ly), 'w')
    f1=open('Rratio_vs_Lx_fixed_Ly{}_zighex.dat'.format(Ly), 'w')
    print('f0=',f0)
    for Lx in range(2,11):  # Breaks down for Ly=1, hence starting from Ly=2
         print("Lx=",Lx)
         Reff=Effective_resistance(V0,R,Lx,Ly)
  ...
  import plot_zighex_Reff_vs_Lx_fixed_Ly 
  import plot_zighex_Rratio_vs_Lx_fixed_Ly 
