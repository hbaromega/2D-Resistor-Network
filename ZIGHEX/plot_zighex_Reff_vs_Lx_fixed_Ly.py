...
import re
print('here')
path = 'Reff_vs_Lx_fixed_Ly*_zighex.dat'
List=[]
...
for Ly in List:
     ...
     dir='.' 
     #dir='../DATAFILES'
     datafile = '{}/Reff_vs_Lx_fixed_Ly{}_zighex.dat'.format(dir,Ly)
...
# Annotation 
xannote=150; yannote=50 # absolute coordinates
...
# SAVE AND SHOW PLOT
# -----------------------------------
fname='Reff_vs_Lx_fixed_Ly_zighex'
